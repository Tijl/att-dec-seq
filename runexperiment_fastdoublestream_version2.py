...
try:
    ...
    dot_cue2 = visual.GratingStim(win, tex=None, mask='gauss', sf=0, size=60,
        name='cue', autoLog=False, color='black')
    dot_cue = visual.GratingStim(win, tex=None, mask='gauss', sf=0, size=192,
        name='cue', autoLog=False, color='black')
    ...
    for (i,y) in enumerate(objectstimuli):
        objectstimtex.append(visual.ImageStim(win,y,size=60,name=y.split(filesep)[1]))
    letterstimtex=[]
